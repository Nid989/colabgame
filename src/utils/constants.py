...
# Screen dimensions from environment config
X_MAX = DEFAULT_ENV_CONFIG["screen_width"]
Y_MAX = DEFAULT_ENV_CONFIG["screen_height"]

# Keyboard keys for action space
KEYBOARD_KEYS = [
    "\t",
    "\n",
    "\r",
...
# Mouse click types used across multiple actions
CLICK_TYPES = ["LEFT", "MIDDLE", "RIGHT", "WHEEL_UP", "WHEEL_DOWN"]

# Computer13 action space definitions
COMPUTER13_ACTIONS = [
    {
        "action_type": "MOVE_TO",
    ...
    },
    {
        ...
        "parameters": {
            "click_type": {"type": str, "range": CLICK_TYPES, "optional": False},
    ...
    },
    {
        ...
        "parameters": {"click_type": {"type": str, "range": CLICK_TYPES, "optional": False}},
    },
    {
    ...
    },
    {
        ...
        "parameters": {"keys": {"type": list, "range": KEYBOARD_KEYS, "optional": False}},
    },
]
